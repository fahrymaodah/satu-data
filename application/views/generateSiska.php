	...
	<div class="col-md-12">
		<div class="card card-primary card-outline">
			<div class="card-header">
				<h4 class="card-title">File Excel Generate Siska <br> <small>Universitas Bumigora</small></h4>
						...
						<?php foreach ($generate as $key => $value): ?>
							<tr>
								...
								<td class="text-center">
									...
									<a class="btn btn-sm btn-danger btn-hps" href="<?php echo base_url('siska/generateHapus/'.$value['id_generate']) ?>">
...
<script>
	$(document).ready(function() {
        ...
        // 	$.ajax({
        //         type:'POST',
        //         url:'<?php echo base_url("siska/generateDetail") ?>',
        //         data: 'id_generate='+id,
        //         dataType: 'json',
